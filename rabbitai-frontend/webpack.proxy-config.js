...
const { rabbitaiPort = 8088, rabbitai: rabbitaiUrl = null } = parsedArgs;
const backend = (rabbitaiUrl || `http://localhost:${rabbitaiPort}`).replace(
  '//+$/',
  '',
...
function toDevHTML(originalHtml) {
  ...
  if (manifest) {
    ...
    // in rabbitai/templates/rabbitai/partials/asset_bundle.html
    html = html.replace(
