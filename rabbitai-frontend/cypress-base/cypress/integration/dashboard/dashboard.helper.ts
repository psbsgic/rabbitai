...
export const WORLD_HEALTH_DASHBOARD = '/rabbitai/dashboard/world_health/';
export const TABBED_DASHBOARD = '/rabbitai/dashboard/tabbed_dash/';

export const CHECK_DASHBOARD_FAVORITE_ENDPOINT =
  '/rabbitai/favstar/Dashboard/*/count';
