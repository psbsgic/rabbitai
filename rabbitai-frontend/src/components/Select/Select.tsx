...
export type RabbitaiStyledSelectProps<
...
>(SelectComponent: SelectComponentType) {
  type SelectProps = RabbitaiStyledSelectProps<OptionType>;
  ...
  const rabbitaiDefaultComponents: SelectComponentsConfig<OptionType> = DEFAULT_COMPONENTS;
  ...
  /**
   * Rabbitai styled `Select` component. Apply Rabbitai themed stylesheets and
  ...
  function StyledSelect(selectProps: SelectProps) {
    ...
    const {
      // additional props for Rabbitai Select
      selectRef,
      labelKey = 'label',
      valueKey = 'value',
      themeConfig,
    ...
    const MaybeSortableSelect = shouldAllowSort
      ...
      : SelectComponent;
    const components = { ...rabbitaiDefaultComponents, ...components_ };
    ...
    return (
      <MaybeSortableSelect
        ...
        // merge default theme from `react-select`, default theme for Rabbitai,
