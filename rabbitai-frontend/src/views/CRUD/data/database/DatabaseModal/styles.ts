...
export const antdCollapseStyles = (theme: RabbitaiTheme) => css`
  .ant-collapse-header {
...
export const formScrollableStyles = (theme: RabbitaiTheme) => css`
  overflow-y: scroll;
  padding-left: ${theme.gridUnit * 4}px;
  padding-right: ${theme.gridUnit * 4}px;
`;

export const antDModalStyles = (theme: RabbitaiTheme) => css`
  .ant-modal-header {
...
export const antDAlertStyles = (theme: RabbitaiTheme) => css`
...
export const formHelperStyles = (theme: RabbitaiTheme) => css`
  .required {
...
export const wideButton = (theme: RabbitaiTheme) => css`
  width: 100%;
...
export const formStyles = (theme: RabbitaiTheme) => css`
  .form-group {
