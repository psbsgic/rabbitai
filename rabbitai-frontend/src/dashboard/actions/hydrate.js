  ...
  return dispatch({
    ...
    data: {
      ...
      dashboardInfo: {
        ...
        dash_save_perm: findPermission('can_save_dash', 'Rabbitai', roles),
        dash_share_perm: findPermission(
          'can_share_dashboard',
          'Rabbitai',
          roles,
        ),
        rabbitai_can_explore: findPermission('can_explore', 'Rabbitai', roles),
        rabbitai_can_share: findPermission(
          'can_share_chart',
          'Rabbitai',
          roles,
        ),
        rabbitai_can_csv: findPermission('can_csv', 'Rabbitai', roles),
        slice_can_edit: findPermission('can_slice', 'Rabbitai', roles),
        common: {
