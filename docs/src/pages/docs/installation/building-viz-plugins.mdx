...
[rabbitai package generator](https://github.com/apache-rabbitai/superset-ui/tree/master/packages/generator-rabbitai)
(`v0.14.7`) to create the new plugin.

```
npm install -g yo @superset-ui/generator-rabbitai
```
...
1. Clone [the `superset-ui` repository](https://github.com/apache-rabbitai/superset-ui) to your
...
4. Finally, run `yo @superset-ui/rabbitai`
...
5. Restart your webpack dev server with `npm run dev-server`. You'll know it worked if you see a
   line stating
   `[Rabbitai Plugin] Use symlink source for @superset-ui/plugin-chart-hello-world @ ^0.0.0`.
