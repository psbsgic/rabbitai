...
services:
  ...
  worker:
    ...
    depends_on:
      ...
      - postgres
      - redis
    command: "celery --app=rabbitai.tasks.celery_app:app worker --pool=gevent --concurrency=500"
    volumes:
  ...
  beat:
    ...
    depends_on:
      ...
      - postgres
      - redis
    command: "celery --app=rabbitai.tasks.celery_app:app beat --pidfile /tmp/celerybeat.pid --schedule /tmp/celerybeat-schedule"
    volumes:
      - ./config/:/app/pythonpath/
  rabbitai:
    image: rabbitai-1.0.1-extended
