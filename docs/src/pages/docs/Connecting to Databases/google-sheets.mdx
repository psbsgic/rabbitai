...
There are a few steps involved in connecting Rabbitai to Google Sheets. This
[tutorial](https://preset.io/blog/2020-06-01-connect-rabbitai-google-sheets/) has the most up to date
