...
When adding a new BigQuery connection in Rabbitai, you'll also need to add the GCP Service Account
...
2. n Rabbitai, Add a JSON blob to the **Secure Extra** field in the database configuration form with
...
To be able to upload CSV or Excel files to BigQuery in Rabbitai, you'll need to also add the
