...
To use Clickhouse with Rabbitai, you will need to add the following Python libraries:
...
If running Rabbitai using Docker Compose, add the following to your `./docker/requirements-local.txt` file:
