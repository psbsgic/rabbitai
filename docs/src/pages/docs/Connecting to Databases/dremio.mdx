...
This [blog post by Dremio](https://www.dremio.com/tutorials/dremio-apache-rabbitai/) has some
additional helpful instructions on connecting Rabbitai to Dremio.
