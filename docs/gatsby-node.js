exports.createPages = ({ actions }) => {
  ...
  createRedirect({
    ...
    toPath: '/docs/installation/installing-rabbitai-using-docker-compose',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    ...
    toPath: '/docs/installation/installing-rabbitai-from-scratch#installing-rabbitai-from-scratch',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: '/installation.html#rabbitai-installation-and-initialization',
    toPath: '/docs/installation/installing-rabbitai-from-scratch#installing-rabbitai-from-scratch',
    isPermanent: true,
  });
  createRedirect({
    fromPath: '/installation.html#a-proper-wsgi-http-server',
    toPath: '/docs/installation/configuring-rabbitai',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    ...
    toPath: '/docs/installation/upgrading-rabbitai',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: '/installation.html#install-rabbitai-with-helm-in-kubernetes',
    toPath: '/docs/installation/installing-rabbitai-from-scratch',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: '/faq.html#why-does-flask-fab-or-rabbitai-freezed-hung-not-responding-when-started-my-home-directory-is-nfs-mounted',
    toPath: '/docs/frequently-asked-questions',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: '/faq.html#what-database-engine-can-i-use-as-a-backend-for-rabbitai',
    toPath: '/docs/frequently-asked-questions',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: 'faq.html#how-do-i-get-rabbitai-to-refresh-the-schema-of-my-table',
    toPath: '/docs/frequently-asked-questions',
    isPermanent: true,
  });
  createRedirect({
  ...
  createRedirect({
    fromPath: '/faq.html#does-rabbitai-work-with-insert-database-engine-here',
    toPath: '/docs/frequently-asked-questions',
    isPermanent: true,
  });
  createRedirect({
