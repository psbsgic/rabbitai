...
class TestPostgresDbEngineSpec(TestDbEngineSpec):
    ...
    def test_extract_errors(self):
        ...
        assert result == [
            RabbitaiError(
                error_type=RabbitaiErrorType.CONNECTION_INVALID_USERNAME_ERROR,
...
psql: error: could not connect to server: Operation timed out
        ...
        assert result == [
            RabbitaiError(
                error_type=RabbitaiErrorType.CONNECTION_INVALID_PASSWORD_ERROR,
        ...
        assert result == [
            RabbitaiError(
                ...
                error_type=RabbitaiErrorType.CONNECTION_UNKNOWN_DATABASE_ERROR,
                level=ErrorLevel.ERROR,
                extra={
                    "engine_name": "PostgreSQL",
                    "issue_codes": [
