...
from rabbitai import app, security_manager
...
from tests.dashboards.rabbitai_factory_util import delete_all_inserted_objects


class DashboardTestCase(RabbitaiTestCase):
