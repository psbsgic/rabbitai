...
class TestRolePermission(RabbitaiTestCase):
    ...
    def assert_can_gamma(self, perm_set):
        ...
        self.assertIn(("can_add_slices", "Rabbitai"), perm_set)
        self.assertIn(("can_copy_dash", "Rabbitai"), perm_set)
        self.assertIn(("can_created_dashboards", "Rabbitai"), perm_set)
        self.assertIn(("can_created_slices", "Rabbitai"), perm_set)
        self.assertIn(("can_csv", "Rabbitai"), perm_set)
        self.assertIn(("can_dashboard", "Rabbitai"), perm_set)
        self.assertIn(("can_explore", "Rabbitai"), perm_set)
        self.assertIn(("can_share_chart", "Rabbitai"), perm_set)
        self.assertIn(("can_share_dashboard", "Rabbitai"), perm_set)
        self.assertIn(("can_explore_json", "Rabbitai"), perm_set)
        self.assertIn(("can_fave_dashboards", "Rabbitai"), perm_set)
        self.assertIn(("can_fave_slices", "Rabbitai"), perm_set)
        self.assertIn(("can_save_dash", "Rabbitai"), perm_set)
        self.assertIn(("can_slice", "Rabbitai"), perm_set)
        self.assertIn(("can_explore_json", "Rabbitai"), perm_set)
    ...
    def assert_can_alpha(self, perm_set):
        ...
        self.assertIn(("can_import_dashboards", "Rabbitai"), perm_set)
    ...
    def assert_can_admin(self, perm_set):
        ...
        self.assertIn(("can_override_role_permissions", "Rabbitai"), perm_set)
        self.assertIn(("can_sync_druid_source", "Rabbitai"), perm_set)
        self.assertIn(("can_override_role_permissions", "Rabbitai"), perm_set)
        self.assertIn(("can_approve", "Rabbitai"), perm_set)
    ...
    def test_is_admin_only(self):
        ...
        self.assertTrue(
            security_manager._is_admin_only(
                security_manager.find_permission_view_menu("can_approve", "Rabbitai")
            )
        )
    ...
    def test_sql_lab_permissions(self):
        ...
        self.assertIn(("can_csv", "Rabbitai"), sql_lab_set)
        self.assertIn(("can_read", "Database"), sql_lab_set)
        self.assertIn(("can_read", "SavedQuery"), sql_lab_set)
        self.assertIn(("can_sql_json", "Rabbitai"), sql_lab_set)
        self.assertIn(("can_sqllab_viz", "Rabbitai"), sql_lab_set)
        self.assertIn(("can_sqllab_table_viz", "Rabbitai"), sql_lab_set)
        self.assertIn(("can_sqllab", "Rabbitai"), sql_lab_set)
    ...
    def test_granter_permissions(self):
        ...
        self.assertIn(("can_override_role_permissions", "Rabbitai"), granter_set)
        self.assertIn(("can_approve", "Rabbitai"), granter_set)
    ...
    def test_gamma_permissions(self):
        ...
        self.assertIn(("can_add_slices", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_copy_dash", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_created_dashboards", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_created_slices", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_csv", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_dashboard", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_explore", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_share_chart", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_share_dashboard", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_explore_json", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_fave_dashboards", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_fave_slices", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_save_dash", "Rabbitai"), gamma_perm_set)
        self.assertIn(("can_slice", "Rabbitai"), gamma_perm_set)
...
class TestSecurityManager(RabbitaiTestCase):
    """
    Testing the Security Manager.
    """

    @patch("rabbitai.security.RabbitaiSecurityManager.raise_for_access")
    def test_can_access_datasource(self, mock_raise_for_access):
        ...
        mock_raise_for_access.side_effect = RabbitaiSecurityException(
            RabbitaiError(
                "dummy",
                RabbitaiErrorType.DATASOURCE_SECURITY_ACCESS_ERROR,
                ErrorLevel.ERROR,
            )
        )
    ...
    def test_can_access_table(self, mock_raise_for_access):
        ...
        mock_raise_for_access.side_effect = RabbitaiSecurityException(
            RabbitaiError(
                "dummy",
                RabbitaiErrorType.TABLE_SECURITY_ACCESS_ERROR,
                ErrorLevel.ERROR,
            )
        )
    ...
    @patch("rabbitai.security.RabbitaiSecurityManager.can_access")
    @patch("rabbitai.security.RabbitaiSecurityManager.can_access_schema")
    def test_raise_for_access_datasource(self, mock_can_access_schema, mock_can_access):
        ...
        with self.assertRaises(RabbitaiSecurityException):
            security_manager.raise_for_access(datasource=datasource)
...
class TestRowLevelSecurity(RabbitaiTestCase):
    """
...
class TestAccessRequestEndpoints(RabbitaiTestCase):
