...
from rabbitai.extensions import appbuilder
...
class Model1Api(BaseRabbitaiModelRestApi):
...
class TestOpenApiSpec(RabbitaiTestCase):
...
class TestBaseModelRestApi(RabbitaiTestCase):
