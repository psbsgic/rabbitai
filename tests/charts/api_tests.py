...
from rabbitai.utils.core import AnnotationType, get_example_database, get_main_database


from tests.base_api_tests import ApiOwnersTestCaseMixin
from tests.base_tests import RabbitaiTestCase, post_assert_metric, test_client
...
class TestChartApi(RabbitaiTestCase, ApiOwnersTestCaseMixin, InsertChartMixin):
    resource_name = "chart"
    ...
    def test_update_chart(self):
        ...
        birth_names_table_id = RabbitaiTestCase.get_table_by_name("birth_names").id
