...
from rabbitai.exceptions import RabbitaiException, RabbitaiGenericDBErrorException
from rabbitai.utils.core import get_example_database
from tests.fixtures.birth_names_dashboard import load_birth_names_dashboard_with_slices

from .base_tests import db_insert_temp_object, RabbitaiTestCase
from .fixtures.datasource import datasource_post


class TestDatasource(RabbitaiTestCase):
    def setUp(self):
        self.original_attrs = {}
    ...
    def test_external_metadata_error_return_400(self, mock_get_datasource):
        ...
        mock_get_datasource.side_effect = RabbitaiGenericDBErrorException("oops")
