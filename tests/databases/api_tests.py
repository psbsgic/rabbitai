...
from rabbitai.errors import RabbitaiError
...
class TestDatabaseApi(RabbitaiTestCase):
    def insert_database(
        self,
        database_name: str,
        sqlalchemy_uri: str,
            ...
            "errors": [
                {
                    ...
                    "extra": {
                        "issue_codes": [
                            {
                                "code": 1010,
                                "message": "Issue 1010 - Rabbitai encountered an error while running a command.",
                            }
                        ]
                    },
                }
