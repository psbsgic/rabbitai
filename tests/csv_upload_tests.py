# isort:skip_file
"""Unit tests for Rabbitai CSV upload"""
import json
import logging
import os
...
from tests.base_tests import get_resp, login, RabbitaiTestCase
...
def test_import_csv_explore_database(setup_csv_upload, create_csv_files):
    ...
    table = RabbitaiTestCase.get_table_by_name(CSV_UPLOAD_TABLE_W_EXPLORE)
...
def test_import_csv(setup_csv_upload, create_csv_files):
    ...
    table = RabbitaiTestCase.get_table_by_name(CSV_UPLOAD_TABLE)
