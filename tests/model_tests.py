...
class TestDatabaseModel(RabbitaiTestCase):
    @unittest.skipUnless(
        RabbitaiTestCase.is_module_installed("requests"), "requests not installed"
    )
    ...
    @unittest.skipUnless(
        RabbitaiTestCase.is_module_installed("thrift"), "thrift not installed"
    )
    @unittest.skipUnless(
        RabbitaiTestCase.is_module_installed("pyhive"), "pyhive not installed"
    )
    ...
    @unittest.skipUnless(
        RabbitaiTestCase.is_module_installed("MySQLdb"), "mysqlclient not installed"
    )
...
class TestSqlaTableModel(RabbitaiTestCase):
