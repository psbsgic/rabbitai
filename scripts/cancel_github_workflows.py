...
Example:
  ...
  export GITHUB_REPOSITORY=apache/rabbitai
...
github_repo = os.environ.get("GITHUB_REPOSITORY", "pengsongbo2016/rabbitai")
...
@click.option(
    "--repo",
    default=github_repo,
    help="The github repository name. For example, pengsongbo2016/rabbitai.",
)
@click.option(
    "--event",
