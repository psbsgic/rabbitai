...
from rabbitai.models.reports import ReportExecutionLog
from rabbitai.reports.logs.schemas import openapi_spec_methods_override
from rabbitai.views.base_api import BaseRabbitaiModelRestApi

logger = logging.getLogger(__name__)


class ReportExecutionLogRestApi(BaseRabbitaiModelRestApi):
