...
from rabbitai.utils.core import generic_find_constraint_name
...
def upgrade():
    # cleanup after: https://github.com/airbnb/rabbitai/pull/1078
    try:
    ...
    # fixed issue: https://github.com/airbnb/rabbitai/issues/466
    try:
