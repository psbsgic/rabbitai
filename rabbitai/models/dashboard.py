...
from rabbitai import app, ConnectorRegistry, db, is_feature_enabled, security_manager
from rabbitai.connectors.base.models import BaseDatasource
from rabbitai.connectors.druid.models import DruidColumn, DruidMetric
...
from rabbitai.models.tags import DashboardUpdater
...
from rabbitai.utils.decorators import debounce
...
class Dashboard(Model, AuditMixinNullable, ImportExportMixin):
    ...
    def update_thumbnail(self) -> None:
        url = get_url_path("Rabbitai.dashboard", dashboard_id_or_slug=self.id)
