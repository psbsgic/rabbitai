...
from rabbitai.charts.commands.bulk_delete import BulkDeleteChartCommand
from rabbitai.charts.commands.create import CreateChartCommand
from rabbitai.charts.commands.data import ChartDataCommand
from rabbitai.charts.commands.delete import DeleteChartCommand
...
from rabbitai.charts.commands.importers.dispatcher import ImportChartsCommand
from rabbitai.charts.commands.update import UpdateChartCommand
from rabbitai.charts.dao import ChartDAO
from rabbitai.charts.filters import ChartAllTextFilter, ChartFavoriteFilter, ChartFilter
from rabbitai.charts.post_processing import apply_post_process
...
from rabbitai.extensions import event_logger, security_manager
...
from rabbitai.utils.screenshots import ChartScreenshot
...
from rabbitai.views.core import CsvResponse, generate_download_headers
from rabbitai.views.filters import FilterRelatedOwners

logger = logging.getLogger(__name__)


class ChartRestApi(BaseRabbitaiModelRestApi):
    ...
    def send_chart_response(
        ...
        if result_format == ChartDataResultFormat.CSV:
            ...
            if not security_manager.can_access("can_csv", "Rabbitai"):
                return self.response_403()
    ...
    def cache_screenshot(self, pk: int, **kwargs: Any) -> WerkzeugResponse:
        ...
        chart_url = get_url_path("Rabbitai.slice", slice_id=chart.id, standalone="true")
    ...
    def thumbnail(self, pk: int, digest: str, **kwargs: Any) -> WerkzeugResponse:
        ...
        url = get_url_path("Rabbitai.slice", slice_id=chart.id, standalone="true")
