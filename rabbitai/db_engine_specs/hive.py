...
class HiveEngineSpec(PrestoEngineSpec):
    ...
    def patch(cls) -> None:
        ...
        from rabbitai.db_engines import hive as patched_hive
    ...
    def df_to_sql(
        ...
        if to_sql_kwargs["if_exists"] == "append":
            raise RabbitaiException("Append operation not currently supported")
        ...
        if to_sql_kwargs["if_exists"] == "fail":
            ...
            if table_exists:
                raise RabbitaiException("Table already exists")
