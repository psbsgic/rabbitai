...
from rabbitai.connectors.base.views import BS3TextFieldROWidget, DatasourceModelView
from rabbitai.connectors.connector_registry import ConnectorRegistry
from rabbitai.connectors.druid import models
...
class DruidColumnInlineView(CompactCRUDMixin, EnsureEnabledMixin, RabbitaiModelView):
...
class DruidMetricInlineView(CompactCRUDMixin, EnsureEnabledMixin, RabbitaiModelView):
...
class Druid(EnsureEnabledMixin, BaseRabbitaiView):
