...
from rabbitai.connectors.base.views import DatasourceModelView
...
class TableModelView(  # pylint: disable=too-many-ancestors
    ...
    description_columns = {
        ...
        "sql": _(
            "This fields acts a Rabbitai view, meaning that Rabbitai will "
    ...
    def edit(self, pk: str) -> FlaskResponse:
        ...
        if isinstance(resp, str):
            return resp
        return redirect("/rabbitai/explore/table/{}/".format(pk))
