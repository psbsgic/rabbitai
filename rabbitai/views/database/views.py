...
from rabbitai.exceptions import CertificateException
from rabbitai.sql_parse import Table
from rabbitai.typing import FlaskResponse
from rabbitai.utils import core as utils
from rabbitai.views.base import DeleteMixin, RabbitaiModelView, YamlExportMixin
...
class DatabaseView(DatabaseMixin, RabbitaiModelView, DeleteMixin, YamlExportMixin):
    ...
    add_template = "rabbitai/models/database/add.html"
    edit_template = "rabbitai/models/database/edit.html"
    validators_columns = {
    ...
    def form_post(self, form: CsvToDatabaseForm) -> Response:
        ...
        if not schema_allows_csv_upload(database, csv_table.schema):
            message = _(
                ...
                "is not allowed for csv uploads. Please contact your Rabbitai Admin.",
...
class ExcelToDatabaseView(SimpleFormView):
    ...
    def form_post(self, form: ExcelToDatabaseForm) -> Response:
        ...
        if not schema_allows_csv_upload(database, excel_table.schema):
            message = _(
                'Database "%(database_name)s" schema "%(schema_name)s" '
                "is not allowed for excel uploads. Please contact your Rabbitai Admin.",
                database_name=database.database_name,
