...
from rabbitai.dashboards.commands.create import CreateDashboardCommand
from rabbitai.dashboards.commands.delete import DeleteDashboardCommand
...
from rabbitai.dashboards.commands.importers.dispatcher import ImportDashboardsCommand
from rabbitai.dashboards.commands.update import UpdateDashboardCommand
from rabbitai.dashboards.dao import DashboardDAO
from rabbitai.dashboards.filters import (
    DashboardAccessFilter,
    DashboardFavoriteFilter,
    DashboardTitleOrSlugFilter,
    FilterRelatedRoles,
)
from rabbitai.dashboards.schemas import (
...
from rabbitai.tasks.thumbnails import cache_dashboard_thumbnail
from rabbitai.utils.cache import etag_cache
from rabbitai.utils.screenshots import DashboardScreenshot
...
class DashboardRestApi(BaseRabbitaiModelRestApi):
    ...
    def __repr__(self) -> str:
        ...
        return "Rabbitai.dashboards.api.DashboardRestApi@v{}{}".format(
